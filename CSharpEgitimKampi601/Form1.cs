...
namespace CSharpEgitimKampi601
{
    public partial class Form1 : Form
    {
        ...
        CustomerOperations customerOperations = new CustomerOperations();//CustomerOperations sınıfından nesne örneği alıyorum
        private void btnCustomerCreate_Click(object sender, EventArgs e)
        {
            var customer = new Customer()//Ekleme işlemi için Customer sınıfından bir tane nesne örneği alıyorum
            {
